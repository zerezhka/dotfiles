...
" --- LSP diagnostics: quiet mode ---
" Only the red squiggly underline, nothing else fires at you while typing.
let g:lsp_diagnostics_highlights_enabled     = 1  " the underline itself
let g:lsp_diagnostics_signs_enabled          = 0  " no gutter icons
let g:lsp_diagnostics_virtual_text_enabled   = 0  " no inline end-of-line text
let g:lsp_diagnostics_echo_cursor            = 0  " no command-line message on cursor hold
let g:lsp_diagnostics_float_cursor           = 0  " no auto popup on cursor hold
...
function! s:on_lsp_buffer_enabled() abort
  ...
  " K left as vim's builtin keywordprg -- no hover popup on demand
endfunction
