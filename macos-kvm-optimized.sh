...
# Location: /usr/local/bin/kvm-wrapper.sh
...
# Before: you need to have ultimate macOS KVM (https://github.com/Coopydood/ultimate-macOS-KVM) and set it up
# ```
#   cd ~/Projects
#   git clone git@github.com:Coopydood/ultimate-macOS-KVM.git
# ```
